"""
Easily create, edit and remove a customized settings file in JSON, YML, YAML, INI or TOML which you can use for storing all of the settings for your application
"""
import json
import yaml
import configparser
